...
const cell_t enterKeyUserIndex  = 6;
const cell_t deleteKeyUserIndex = 7;
const cell_t blkUserIndex       = 8;
const cell_t inUserIndex        = 9;
const cell_t outUserIndex       = 10;
const cell_t scrUserIndex       = 11;
const cell_t offsetUserIndex    = 12;
const cell_t contextUserIndex   = 13;
const cell_t currentUserIndex   = 14;
const cell_t stateUserIndex     = 15;
const cell_t baseUserIndex      = 16;
const cell_t dplUserIndex       = 17;
const cell_t fldUserIndex       = 18;
const cell_t cspUserIndex       = 19;
const cell_t rnumUserIndex      = 20;
const cell_t hldUserIndex       = 21;
